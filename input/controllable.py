...
statemachine = smart_contract_state_machine('controllable')
...
statemachine.constants.append(100)
...
sender5 = z3.BitVec('sender4',256)
value5 = z3.BitVec('value4',256)
...
r1 = z3.Implies(func('_burn'), totalSupply < prev(totalSupply))
# r2 = z3.Implies(func('mint'), balanceOf[0] == 0)
r2 = z3.Implies(func('transfer'), totalSupply > prev(totalSupply))
