...
# state
statemachine = smart_contract_state_machine('crowdfunding')
...
positive_traces.append(
    [
        ...
        ('invest', now == 12224, sender == 0x114517, value == 100),
        ('invest', now == 22225, sender == 0x114518, value == 100),
        ('invest', now == 33336, sender == 0x114519, value == 100),
    ]
)
